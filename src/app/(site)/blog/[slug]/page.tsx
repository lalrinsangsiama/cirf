...
export default async function BlogPostPage({
  ...
  Promise.resolve(
    ...
    logger.warn('Failed to update blog view count', { postId: post.id, error: err instanceof Error ? err.message : String(err) })
  })
        ...
        {post.citations && post.citations.length > 0 && (
          <div className="mt-12 pt-8 border-t border-stone/20">
            ...
            <div className="space-y-4">
              {post.citations.map((citation: Citation) => (
                <div key={`${citation.author}-${citation.year}-${citation.title}`} className="text-sm text-stone">
                  <p>
